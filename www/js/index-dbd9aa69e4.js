			...
			success:function(data){
				for(var i=0;i<data.length;i++)
				{
					var msg="<ul>"+
									...
									"<li>公司名称："+data[i].name+"</li>"+
									"<li>企业类型："+data[i].category+"</li>"+
									"<li>企业链接："+data[i].url+"</li>"+
									"<li>企业规模："+data[i].category+"人</li>"+
									"<li>职位："+data[i].reportto+"</li>"+
									"<li>项目："+data[i].projects+"</li></ul>";
					$("#contents").append(msg);
				}
			}
		});
	...
	function getProject(){
		$.ajax({
			...
			success:function(data){
				...
				{
					var msg="<ul>"+
									"<li>项目类型："+data[i].category+"</li>"+
									"<li>项目链接："+data[i].url+"</li>"+
									"<li>项目描述："+data[i].description+"人</li>"+
									"<li>项目详情："+data[i].detail+"</li>"+
									"<li>运用技术："+data[i].projects+"</li></ul>";
					$("#contents").append(msg);
				}
			}
		});
